...
Version: Enterprise
Ultima actualizacion: 25 de julio de 2026
Idioma: Espanol
...
- Cuando `settings.inboxes` está vacío, cualquier agente de la cuenta puede agregarse a `settings.agents` y asignarse a un ítem. Con inboxes configurados, las asignaciones manuales nuevas requieren acceso a por lo menos uno; al mover un ítem, sus agentes asignados se agregan automáticamente al funnel destino sin cambiar sus permisos de inbox.
